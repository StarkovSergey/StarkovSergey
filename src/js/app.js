...
console.log(
  ...
  '[x] вёрстка семантическая: nav, footer, header, main, section, h1, h2, h3, b, strong (10 * 2 = 20, +20) \n',
  ...
  '[x] на странице СV присутствует изображение (+10) \n',
  ...
  '[x] дизайн, оформление, качество выполнения CV не ниже чем в примерах CV, приведённых в материалах к задани (+10) \n',
);
